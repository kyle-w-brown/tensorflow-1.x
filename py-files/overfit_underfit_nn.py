# -*- coding: utf-8 -*-
"""overfit_underfit_nn.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1wicRADj-GSECs_BeQXFtWq1G40TbQjpv

# Overfitting and Underfitting Neural Networks with `tf-1.x`

---

Learning how to deal with overfitting is important. Although it's often possible to achieve high accuracy on the training set, what we really want is to develop models that generalize well to a testing data (or data they haven't seen before).
...
"""**l2(0.001)** means that every coefficient in the weight matrix of the layer will add 0.001 x weight_coefficient_value x 2 to the total loss of the network. Note that because this penalty is only added at training time, the loss for this network will be much higher at training than at test time.
